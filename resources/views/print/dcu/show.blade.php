...
@section('content')
    @include('components.content-title', ['active' => $title, 'menus' => ['Cetak Dokumen', 'DCU', $title]])
            ...
            <div class="card">
                <div class="card-header card-no-border">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('print-documents.dcu') }}" class="btn btn-light btn-sm">
                        ...
                        <table class="table card-table table-bordered table-striped table-vcenter text-nowrap" id="datatable">
                            <thead class="table-success">
                                <tr>
                                    ...
                                    <th class="text-start">Pelaksanaan DCU</th>
                                ...
                                @forelse($records as $record)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a class="btn btn-success btn-sm" href="{{ route('print-documents.dcu.detail', $record->id) }}">
                                                <i data-feather="eye" style="width: 16px; vertical-align: middle;"></i>
                                                Lihat
                                            </a>
                                            --}}
