...
<div class="page-wrapper compact-wrapper" id="pageWrapper">
    ...
    <div class="error-wrapper">
        <div class="container">
            <svg class="stroke-icon" style="height: 326px;">
                <use href="/images/icon-sprite.svg#error-@yield('code')"></use>
            </svg>
            <div class="error-heading" style="margin-top: 0px;">
                <h1 class="font-success">@yield('code')</h1>
            </div>
            ...
            <div>
                <a class="btn btn-success-gradien btn-lg" href="javascript:history.back()">
                    BACK TO HOME PAGE
                </a>
            </div>
        </div>
