...
@section('content')
    @include('components.content-title', ['active' => 'Classes', 'menus' => ['Syncs', 'Classes']])
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Synchronizing Student Classes</h5>
                ...
                <form action="{{ route('sync-classes.store') }}" method="POST">
            ...
            <div class="card">
                <div class="card-header card-no-border pb-0">
                    ...
                    <h4 class="card-title mb-0">
                        Student Classes Synchronize Histories
                    </h4>
                </div>
